...
from var_autoencoder_methods import var_autoencoder_model
# change seed
m = 5000
w1, w2 = 0.1, 0.3
noise = 0.05
...
options_vae['dim_hidden'] = 3 # dimension of latent variabels
...
options_vae['num_iterations'] = 3000 # number of iterations
...
options_vae['train_restore'] = 'train' # 'train' or 'restore'
options_vae['output_generate_type'] = 'gauss_distrib' # 'gauss_distrib' or 'gauss_point_estimate' or 'bernoulli_distrib'

vae_model = var_autoencoder_model(options_vae)
